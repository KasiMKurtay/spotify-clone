      ...
      <ScrollArea className="h-full relative z-10">
        <div className="min-h-full">
          ...
          <div className="bg-black/20 backdrop-blur-sm">
            <div className="grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-10 py-4 text-sm text-zinc-400 border-b border-white/5">
              <div>#</div>
              <div>Title</div>
            ...
            <div>
              <div className="space-y-2 py-4">
                {currentAlbum?.songs.map((song, index) => {
                  const isCurrentSong = song._id; // şu anlık sabit
                  return (
                    <div
                      key={song._id}
